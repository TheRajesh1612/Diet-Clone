  ...
  return (
    ...
    <div className="on-campus-drive">
        ...
        <div className="companies">
            ...
            <a href="https://www.hp.com/us-en/shop"><img src="../public/assests/homePage/hp.svg" alt="Google" /></a>
            </div>
            <div className="tata drive">
            <a href="https://www.tatamotors.com/"><img src="../public/assests/homePage/tata.svg" alt="Google" /></a>
            </div>
            <div className="infosys drive">
            <a href="https://www.infosys.com/"><img src="../public/assests/homePage/infosys.svg" alt="Google" /></a>
            </div>
